...
$query1 = mysqli_query($con,"select * from entrance_exam where status='unsatisfactory' and (account=' ' or account='seen')")or die(mysqli_error($con));
		...
		?>	 		
					<li>
						<a href="viewfeedback.php">
							<span>View feedback (<?php include '../connection.php'; $count_item=mysqli_query($con,"select * from feed_back" ) or die(mysqli_error());
