...
<p align="center" style="color: #2773d8;font-family: time new romans;font-size: 17;">Number of users:<?php include '../connection.php'; $count_item=mysqli_query($con,"select * from user " ) or die(mysqli_error($con));
